(function (global, factory) {
  ...
  function bindModelCallbacks(scope) {
  ...
  var Cotton = /*#__PURE__*/function () {
    ...
    _createClass(Cotton, [{
      ...
      value: function setData(scope, type) {
        ...
        var classHandler = type ? 'add' : 'remove';
        var callbackHandler = type ? 'enterScene' : 'leaveScene';
        ...
        if (_toConsumableArray(el.classList).indexOf(params.conttonInitClass) > -1) el.classList[classHandler](params.cottonMovingClass);
