    ...
    _createClass(Cotton, [{
      ...
      value: function move() {
        ...
        function animateMouse() {
          ...
          if (params.central) el.style.transform = "translate(calc( -50% + ".concat(mouseData.x / params.resistance, "px ), calc( -50% + ").concat(mouseData.y / params.resistance, "px ))");else el.style.transform = "translate(".concat(mouseData.x / params.resistance, "px, ").concat(mouseData.y / params.resistance, "px)");
        }
